...
@implementation UIColor (TimeLine)
...
+(UIColor*)randomColor
{
    UIColor *color =  [UIColor colorWithRed:arc4random_uniform(256)/255.0f green:arc4random_uniform(256)/255.0f blue:arc4random_uniform(256)/255.0f alpha:1.0f];
    return color;
}
@end
